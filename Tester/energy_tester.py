...
# 0. Build the model
model = arch.ModelArch(modelStructure={"Conv1DGated": {"layers": [128], "kernel_size": 96},
                                       "Conv1DGated_1": {"layers": [128], "kernel_size": 192},
                                       "Conv1DGated_2": {"layers": [128], "kernel_size": 288},
                                       "Conv1DGated_3": {"layers": [128], "kernel_size": 480},
...
trained_model = train.ModelTraining(model=model).trainModel(dataInDataFrameFormat=ren_prod_italy,
                                                            feature_variables=feature_variables,   # "year" | "month" | "day" | "day_of_week" | "hour" | "minute"
